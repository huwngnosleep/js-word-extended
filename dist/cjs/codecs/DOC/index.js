...
exports.read = exports.readFile = exports.parse_cfb = void 0;
...
function getDocTxt(fib, docStream, tableStream) {
    ...
    var plcPcd = (0, clx_1.parseClx)(clx);
    var txt = (0, clx_1.getTxt)(fibRgLw, plcPcd, docStream);
    /* grab the body text */
    return txt.length == fibRgLw.ccpText ? txt.slice(0, -1) : txt.slice(0, fibRgLw.ccpText);
}
function parse_cfb(file) {
    /* [MS-DOC] 2.4.1 Retrieving Text */
    var wordDocument = (0, cfb_1.find)(file, "/WordDocument");
    var wordStream = wordDocument.content;
    var fib = (0, fib_1.readFib)(wordStream);
    var tableName = fib.base.fWhichTblStm === 1 ? "/1Table" : "/0Table";
    var table = (0, cfb_1.find)(file, tableName);
...
function readFile(filePath) {
    var file = (0, cfb_1.read)(filePath, { type: "file" });
    return parse_cfb(file);
}
exports.readFile = readFile;
function read(data) {
    var file = (0, cfb_1.read)(data, { type: "buffer" });
    return parse_cfb(file);
}
exports.read = read;
